...
Parsed 10,458 match JSONs from Cricsheet into a single ball-by-ball dataframe (2.3M+ rows)
...
Model Performance
ModelAUCLog LossBrier ScoreLogistic Regression0.9170.3600.118XGBoost0.9230.3480.113XGBoost (Calibrated)0.9240.3450.112
