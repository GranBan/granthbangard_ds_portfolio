...
### 2. Customer Churn Analysis and Retention Intelligence
- Built a business-focused churn intelligence system using subscription customer data to identify high-risk users and key behavioral drivers of churn.
- Performed end-to-end analysis: data cleaning, exploratory analysis, feature engineering, and machine learning modeling optimized for recall and ROC-AUC rather than accuracy.
- Translated model outputs into actionable retention strategies by customer risk segment, bridging predictive analytics with real-world business decisions.
